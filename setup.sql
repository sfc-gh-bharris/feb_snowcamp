...
COPY files INTO @SNOW_DYNAMIC_TABLES_DE.NOTEBOOKS.FILES/JAVA_UDTF_1_NOTEBOOK/
    FROM @SETUP_DB.FILES.NOTEBOOK_FILES FILES = ('JAVA_UDTF_1_NOTEBOOK.ipynb');
...
CREATE OR REPLACE NOTEBOOK SNOW_DYNAMIC_TABLES_DE.NOTEBOOKS.JAVA_UDTF_1_NOTEBOOK
    FROM '@SNOW_DYNAMIC_TABLES_DE.NOTEBOOKS.FILES/JAVA_UDTF_1_NOTEBOOK' 
    MAIN_FILE = 'JAVA_UDTF_1_NOTEBOOK.ipynb' 
    QUERY_WAREHOUSE = 'SNOW_DYNAMIC_TABLES_DE_WH';
